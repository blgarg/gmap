...
var APIkey = "ABQIAAAAdPob-pCJYuOJnO8CmbFhXxT7bhpqiVbtrumEJ0N5Aces1oJABBTiCLvvatmPbtleK1ixPavengOa9g";
...
function PdMarker(a, b, tooltip) {
    ...
    this.oldImagePath = b.icon.image;
  }		
	else
...
function addMarkerToMapList(map,marker) {
	...
	if (typeof map.pdMarkers == "undefined") {
		map.pdMarkers = new Array();
	}
	// add to list
...
PdMarker.prototype.topMarkerZIndex = function() {
  ...
  //SJ Edit
  topZIndex += 1;
  this.setMarkerZIndex (topZIndex);
}
